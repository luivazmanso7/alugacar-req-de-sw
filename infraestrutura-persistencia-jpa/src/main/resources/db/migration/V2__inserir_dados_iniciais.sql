...
('COMPACTO', 'Compacto', 'Carros de tamanho médio com bom espaço interno', 119.90, 'Civic, Corolla, Cruze', 10),
...
('LUXO', 'Luxo', 'Veículos premium com alto nível de conforto', 399.90, 'BMW X3, Audi Q5, Mercedes GLC', 3);
...
('JKL3456', 'Honda Civic 2.0', 'COMPACTO', 'São Paulo', 119.90, 'DISPONIVEL', 'PATIO-SAO PAULO', 'São Paulo'),
('MNO7890', 'Toyota Corolla 2.0', 'COMPACTO', 'São Paulo', 119.90, 'DISPONIVEL', 'PATIO-SAO PAULO', 'São Paulo'),
...
('YZA3456', 'BMW X3 2.0', 'LUXO', 'São Paulo', 399.90, 'DISPONIVEL', 'PATIO-SAO PAULO', 'São Paulo');
...
('HIJ0123', 'Honda Civic 2.0', 'COMPACTO', 'Rio de Janeiro', 119.90, 'DISPONIVEL', 'PATIO-RIO DE JANEIRO', 'Rio de Janeiro'),
